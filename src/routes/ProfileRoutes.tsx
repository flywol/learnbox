...
const EditPersonalInfoPage = lazy(() => import("../features/profile/pages/EditPersonalInfoPage"));
const EditSchoolInfoPage = lazy(() => import("../features/profile/pages/EditSchoolInfoPage"));
const SessionConfigPage = lazy(() => import("../features/profile/pages/SessionConfigPage"));

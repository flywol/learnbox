...
interface TeacherWelcomeModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function TeacherWelcomeModal({ isOpen, onClose }: TeacherWelcomeModalProps) {
  const handleSkip = () => {
    localStorage.setItem('teacher-welcome-seen', 'true');
    onClose();
  };

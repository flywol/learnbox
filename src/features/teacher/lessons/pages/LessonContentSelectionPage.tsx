...
export default function LessonContentSelectionPage() {
  ...
  const contentTypes: ContentType[] = [
    {
      ...
      route: `/teacher/subject/${subjectId}/lesson/add/video`,
    ...
    },
    {
      ...
      route: `/teacher/subject/${subjectId}/lesson/add/files`,
    ...
    },
    {
      ...
      route: `/teacher/subject/${subjectId}/lesson/add/assignment`,
    ...
    },
    {
      ...
      route: `/teacher/subject/${subjectId}/lesson/add/quiz`,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
        <h2 className="text-lg font-medium text-gray-900 mb-6">
          Select a lesson content to add:
        </h2>
